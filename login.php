...
if(isset($_POST['btn_login'])){
    ...
    }else if($row['username']==$username AND $row['password']==$password AND $row['role']=="Viewer" AND $row['is_active']=="1"){
        $_SESSION['user_id']=$row['user_id'];
        $_SESSION['username']=$row['username'];
        $_SESSION['fullname']=$row['fullname'];
        $_SESSION['role']=$row['role'];
...
<head>
  ...
  <link rel="shortcut icon" href="img/cern1.jpeg">
...
<div class="login-box">
  <div class="login-logo">
    <a href="index.php"><b>HGTD Production Database Website</b></a>
  </div>
  <!-- /.login-logo -->
    ...
    <form action="" method="post" autocomplete="off">
      ...
      <div class="row">
        ...
        <div class="col-xs-4">
            ...
            <p class="box-register">Are you new here? <a href="registration.php"><p style=  color:#0000FF>Create account</a></p> 
        </div>
      </div>
      <?php
        if(!empty($message)){
